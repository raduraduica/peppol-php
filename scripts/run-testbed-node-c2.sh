...
docker run -d --network=testnet --name=nc1.docker -v $PEPPOL_PHP_DIR/tls:/tls -v $PEPPOL_PHP_DIR:/var/www/html/apps/peppol-php -v $PEPPOL_PHP_DIR/p12transport:/p12transport c2
